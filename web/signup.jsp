    ...
    <body>
        ...
        <div class="container">
            <form action="SignupServlet" method="POST">
                ...
                <input class="textf" type="text" placeholder="First Name" name="EfirstName">
                <input class="textf" type="text" placeholder="Last Name" name="ElastName">
                <input class="textf" type="email" placeholder="Email Address"
                       name="Eemail">
                <input class="textf" type="text" placeholder="Mobile number"
                       name="Emobile">
                <input class="textf"  type="password" placeholder="Password" name="Epassword">
